...
png("tweets_over_day.60.trending.png", width = width_, height = height_, bg = "transparent")
...
png("tweets_over_day.60.periodic_trending.png", width = width_, height = height_, bg = "transparent")
...
png("tweets_over_day.60.periodic_trending.sliding.png", width = width_, height = height_, bg = "transparent")
