...
png("tweets_over_day.60.roastpepper.trending.png", width = 1200, height = 300, bg = "transparent")
d = read.delim("tweets_over_day.60.roastpepper.trending.tsv", header=FALSE)
freqs = d$V2
means = d$V3
min_trends = d$V4
range_ = c(0, max(append(freqs,min_trends)))
